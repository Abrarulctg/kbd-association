...
import { faCaretRight, faPhoneAlt, faQuoteRight } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-5">
                        ...
                        <div className="row">
                            <div className="col-md-6 sm-6 footer-list">
                                <ul>
                ...
                <div className="text-center">
                    ...
                    <a className="developer" href="#"> Abrarul Hoque</a>
                </div>
            </div>
        </div>
    );
